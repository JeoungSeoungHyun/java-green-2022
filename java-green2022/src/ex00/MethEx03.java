...
/**
 * 메서드 규칙
 * 1. 투입구의 출구가 있다. 단, 출구(return)는 항상 필요하지 않다.
 ...
 * 6. 메서드는 왜 만드는가? 특정 목적(역할)을 수행하는 모듈(코드 꾸러미)을 만들어 두려고.
 * -캡슐화, 재사용, 코드관리도 편함, 메모리 관리도 잘된다.
...
public class MethEx03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("변경 전 sum : " + m.sum);
        m.start(); // 클래스명 생략 가능(같은 클래스에 있기 때문에)
        System.out.println("변경 후 sum : " + m.sum);
    }
}
